                ...
                <div class="row">
                  <div class="mb-3 col">
                    ...
                    <input type="text" class="form-control" id="designation" name="designation"
                      value="{{ old('email') }}" placeholder="Engineer..." />
                  </div>
                ...
                <div class="row">
                  ...
                  <div class="mb-3 col">
                    ...
                    <select name="page" class="form-control">
                      ...
                      <option value="planning-development">Planning And Development</option>
                      <option value="project-director">Project Director</option>
                      <option value="qec">Quality Enhancement Cell</option>
                      <option value="resident-officer">Resident Officer</option>
