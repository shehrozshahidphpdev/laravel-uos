      ...
      <div class="row justify-content-center">
        <div class="row col-md-10">
          ...
          <div class="card card-primary card-outline mb-4">
            ...
            <x-base-form action="{{ route('admin.department.update', $department->id) }}" method="put" :media="true">
              <!--begin::Body-->
              <div class="card-body">
                <div class="row">
                  <div class="mb-3 col">
                  ...
                  <div class="mb-3 col">
                    ...
                    <img id="preview" src="{{ asset('storage/admin/uploads/' . $department->image) }}" width="100"
                      class="mt-2" />
                  </div>
                </div>
                <div class="row">
                  <div class="mb-3">
                    ...
                    <div id="course-wrapper">
                      <div class="d-flex flex-wrap align-items-center gap-2 mb-2 course-group">
                        @foreach ($department->offered_courses as $key => $course)
                          {{-- if the course is > 0 show the fields with trash icon --}}
                          @if($key < 1)
                            <div class="input-group">
                              <input type="text" class="form-control" name="offered_courses[]"
                                placeholder="Enter course name" value="{{ old('offered_courses') ?? $course }}" />
