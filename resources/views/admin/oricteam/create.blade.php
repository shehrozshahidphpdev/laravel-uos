      ...
      <div class="row justify-content-center">
        <div class="row col-md-12">
          <div class="card card-primary card-outline mb-4">
            ...
            <x-admin.show-errors />
            <x-base-form action="{{ route('admin.oric-team.store') }}" :media="true">
              <div class="card-body">
                <div class="row">
                  <div class="mb-3 col">
                    ...
                    <input type="text" class="form-control" name="dept_name" id="dept_name"
                      placeholder="Enter Department Name" value="{{ old('dept_name', '') }}" />
                  </div>
                  <div class="mb-3 col">
                    <label for="members" class="form-label">Member</label>
                    <input type="text" class="form-control" id="memberss" name="members" value="{{ old('members') }}"
