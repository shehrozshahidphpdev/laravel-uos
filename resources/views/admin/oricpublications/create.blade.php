<x-admin.layouts.master title=" Admin Oricpublication Create">
  @push('styles')
    <style>
      .input-group {
        margin-bottom: 2rem;
      ...
      <div class="row justify-content-center">
        <div class="row col-md-12">
          <div class="card card-primary card-outline mb-4">
            ...
            <x-admin.show-errors />
            <x-base-form action="{{ route('admin.oric-publication.store') }}" :media="true">
              <div class="card-body">
                <div class="row">
                  <div class="mb-3 col">
                  ...
                  <div class="mb-3 col">
                    ...
                    <input type="text" class="form-control" id="ranks" name="rank" value="{{ old('rank') }}"
                ...
                <div class="row">
                  ...
                  <div class="mb-3 col">
                    ...
                    <input type="text" class="form-control" name="category" id="category"
                      placeholder="Enter Category Here..." value="{{ old('category', '') }}" />
                ...
                <div class="row">
                  ...
                  <div class="mb-3 col">
                    ...
                    <input type="text" class="form-control" id="a" name="journal" value="{{ old('journal') }}"
                ...
                <div class="row">
                  ...
                  <div class="mb-3 col">
                    ...
                    <input type="text" class="form-control" id="if" name="if" value="{{ old('if') }}"
                      placeholder="Enter Member Name" />
                  </div>
                </div>
                    ...
                    <div class="author-group">
                      <div class="input-group">
                        <input type="text" class="form-control" id="authors" name="authors[]"
                          value="{{ old('authors[]') }}" placeholder="Enter Author Name..." />
