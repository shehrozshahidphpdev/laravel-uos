      ...
      <div class="row justify-content-center">
        <div class="row col-md-12">
          <div class="card card-primary card-outline mb-4">
            ...
            @endif
            <x-base-form action="{{ route('admin.settings.store') }}" :media="true">
              <!--begin::Body-->
              <div class="card-body">
                <div class="row">
                  <div class="mb-3 col">
                    ...
                    <input type="tel" class="form-control" id="phone_no" name="phone_no"
                      value="{{ old('phone_no', '') }}" placeholder="+92 99 9999999" />
                  </div>
                ...
                <div class="row">
                  ...
                  <div class="mb-3 col">
                    ...
                    <input type="text" class="form-control" name="copyrights" value="{{ old('copyrights', '') }}"
                      id="copyrights" />
                  </div>
                </div>
              </div>
