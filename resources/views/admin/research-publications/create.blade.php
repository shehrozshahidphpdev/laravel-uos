      ...
      <div class="row justify-content-center">
        <div class="row col-md-12">
          <div class="card card-primary card-outline mb-4">
            ...
            <x-admin.show-errors />
            <x-base-form action="{{ route('admin.research-publications.store') }}">
              <div class="card-body">
                <div class="row">
                  <div class="mb-3 col">
                ...
                <div class="row">
                  ...
                  <div class="mb-3 col">
                    ...
                    <input type="text" class="form-control" name="impact_factor" value="{{ old('impact_factor') }}"
                  ...
                  <div class="mb-3 col">
                    ...
                    <select name="dept_id" class="form-select">
                      ...
                      @forelse($departments as $department)
                        <option value="{{ $department->id }}">{{ ucwords($department->dept_name) }}
                        </option>
                      @empty
