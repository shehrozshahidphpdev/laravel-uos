      ...
      <div class="row justify-content-center">
        <div class="row col-md-12">
          <div class="card card-primary card-outline mb-4">
            ...
            <x-admin.show-errors />
            <x-base-form action="{{ route('admin.tables-rows.store') }}" :media="true">
                  ...
                  <div class="mb-3 col">
                    @foreach ($tableData->columns as $column)
                      <div class="row-group mb-3">
                        <label for="table" class="form-label">{{ $column }}</label> <span class="text-danger">*</span>
                        <input type="text" class="form-control" name="rows[{{$column}}]"
