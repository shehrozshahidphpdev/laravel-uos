@props(['settings'])
<x-user.layouts.master :settings="$settings" title="home oric">
  <main class="main">
        ...
        <aside class="navigation">
          <div class="navigation-container">
            <ul class="navigation__list">
              <li class="navigation__item"><a href="{{ route('user.oric') }}" class="go">ORIC Office <span
                    class="icon"></span></a></li>
              <li class="navigation__item"><a href="{{ route('user.oric-team') }}" class="go">ORIC Team <span
                    class="icon"></span></a></li>
              <li class="navigation__item"><a href="{{ route('user.oric-publications') }}" class="go">Publications <span
                    class="icon"></span></a></li>
            </ul>
          </div>
        </aside>
