      ...
      <div class="container">
        ...
        <div class="contact-cards grid">
          <div class="contact-card">
            ...
            <h3 class="contact-card__caption">{{ $settings->phone_no }}</h3>
            <p class="contact-card__text">Phone Support</p>
          </div>
          ...
          <div class="contact-card">
            ...
            <h3 class="contact-card__caption">{{ $settings->email }}</h3>
            <p class="contact-card__text">Email Address</p>
          </div>
          ...
          <div class="contact-card">
            ...
            <h3 class="contact-card__caption">University of Sahiwal, University Road, Sahiwal, Pakistan</h3>
            <p class="contact-card__text">University Address</p>
          </div>
        </div>
      </div>
    </section>
